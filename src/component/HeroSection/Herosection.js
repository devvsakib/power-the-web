    ...
    <>
      <div className='hero-section flex justify-between py-10 items-center '>
        <div className='hero-content pb-10 mx-auto text-center'>
          ...
          <p className='mt-5 text-xl uppercase tracking-widest font-semibold  ptw-text-animation'>An opensouce Projects for Web Developer.<br/> Start your development from here.</p>
        </div>
      </div>
    </>
  )
